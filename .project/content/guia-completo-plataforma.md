...
> Documento de referência para IA de suporte. Cobre todas as funcionalidades, fluxos e comportamentos da plataforma.

---

## O que é o HiveBudget
...
O app tem as seguintes páginas principais, acessíveis pelo menu lateral:

| Página | O que faz |
|--------|-----------|
| **Dashboard** | Visão geral do mês: renda, despesas, metas, gráficos |
| **Planejamento** | Distribui a renda em categorias de despesa e metas |
| **Transações** | Registra e acompanha todas as movimentações |
| **Renda** | Gerencia fontes de renda (salário, freelance, etc.) |
| **Categorias** | Cria e organiza categorias de gastos |
| **Contas** | Controla saldos de contas bancárias e cartões |
| **Metas** | Acompanha objetivos de poupança |
...
- **Ignorar neste mês** — zera o valor planejado só para o mês atual (ex: feriado, férias sem salário)
- **Restaurar** — volta ao valor padrão após ter ignorado
- **Editar fonte** — abre o diálogo de escopo (ver seção Renda)
...
Ações:
- Clicar na categoria abre o modal de alocação
- É possível criar novas categorias diretamente pelo planejamento
...
| **Confirmada** | Realizada e contabilizada no saldo |
...
- Com ou sem data de término
- Geradas como "pendentes" para confirmação manual (ou automática, se configurado)
...
Despesas fixas podem ser criadas de duas formas:
1. **Pela página de Transações**: ao criar uma nova despesa, ativar o toggle "Despesa fixa", escolher a frequência e o dia de vencimento
2. **Pelo Planejamento**: no menu de 3 pontos de uma categoria, clicar em "Adicionar despesa fixa"
...
| Modo | O que o parceiro vê |
|------|---------------------|
| **Visível** | Todas as transações, incluindo pessoais |
| **Unificado** | Só os totais; detalhes pessoais ficam ocultos |
| **Privado** | Nada das transações pessoais do outro |
...
### Plano
- Visualização do plano atual (Solo ou Duo)
- Upgrade ou gerenciamento de assinatura
...
### Privacidade (Duo)
- Alterar modo de privacidade do orçamento
- Configurar privacidade individual
...
Use a frequência **Pontual** (once) e configure o mês e ano específico.
...
Dentro do app, em Configurações > Suporte, o usuário pode:
- Acessar o tutorial interativo
- Enviar feedback
- Reportar problemas
